...
.PHONY: setup env verify test smoke backtest live-paper paper-check paper-status paper-stop paper-liquidate e2e baseline clean llm-smoke llm-report lint
