...
- Stat-arb price-history export: `python scripts/export_stat_arb_price_history.py --source-mode providers --output <file>` (builds validated training JSON from Massive primary, Alpaca validation, and Alpha Vantage repair)
